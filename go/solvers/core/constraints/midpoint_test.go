...
func TestMidpointEvaluator(t *testing.T) {
	...
	p2a := &schema.Entity{Id: "p2a", EntityType: &schema.Entity_Point{Point: &schema.PointEntity{X: 2.0, Y: 4.0}}}
	...
	scenario := &schema.Sketch{Entities: []*schema.Entity{p1, p1a, p2a, l1}, Constraints: []*schema.Constraint{c}}
